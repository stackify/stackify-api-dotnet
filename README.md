...
|-----------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| Stackify API                      | [![NuGet](https://img.shields.io/nuget/v/StackifyLib.svg)](https://www.nuget.org/packages/StackifyLib/)                                             |
| NLog.Targets.Stackify             | [![NuGet](https://img.shields.io/nuget/v/NLog.Targets.Stackify.svg)](https://www.nuget.org/packages/NLog.Targets.Stackify/)                         |
| StackifyLib for AspNetCore        | [![NuGet](https://img.shields.io/nuget/v/StackifyLib.AspNetCore.svg)](https://www.nuget.org/packages/StackifyLib.AspNetCore/)                       |
| Stackify .NET Core LoggerFactory  | [![NuGet](https://img.shields.io/nuget/v/StackifyLib.CoreLogger.svg)](https://www.nuget.org/packages/StackifyLib.CoreLogger/)                       |
| StackifyLib.ELMAH                 | [![NuGet](https://img.shields.io/nuget/v/StackifyLib.ELMAH.svg)](https://www.nuget.org/packages/StackifyLib.ELMAH/)                                 |
| StackifyLib.StackifyTraceListener | [![NuGet](https://img.shields.io/nuget/v/StackifyLib.StackifyTraceListener.svg)](https://www.nuget.org/packages/StackifyLib.StackifyTraceListener/) |
| StackifyLib.log4net.v1_2_10       | [![NuGet](https://img.shields.io/nuget/v/StackifyLib.log4net.v1_2_10.svg)](https://www.nuget.org/packages/StackifyLib.log4net.v1_2_10/)             |
| StackifyLib.log4net               | [![NuGet](https://img.shields.io/nuget/v/StackifyLib.log4net.svg)](https://www.nuget.org/packages/StackifyLib.log4net/)                             |
| StackifyLib.nLog                  | [![NuGet](https://img.shields.io/nuget/v/StackifyLib.nLog.svg)](https://www.nuget.org/packages/StackifyLib.nLog/)                                   |
...
LogMsg msg = new LogMsg {
        ...
        AppDetails = new LogMsgGroup() {AppName = "My app", Env = "Prod", ServerName = Environment.MachineName},
        data = StackifyLib.Utils.HelperFunctions.SerializeDebugData(new { color= "red"}, true),
        Msg = "My log message",
        Level = "ERROR"
};
